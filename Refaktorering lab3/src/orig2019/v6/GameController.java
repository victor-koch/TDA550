...
//	private final int updateInterval;
	...
	private final Queue<Integer> keypresses;
...
//		this.updateInterval = 150;
	...
	/**
	 * Get a key press, and remove it from the queue. Returns 0 if no key press is
	 * available.
	 *
	 *
	 ...
	 */
	public void startGame(@SuppressWarnings("hiding") final GameModel gameModel) {
		if (this.isRunning) {
